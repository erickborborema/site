            ...
            if (isMobile) {
              return (
                <motion.div
                  ...
                  transition={{ duration: 0.3, delay: (index % services.length) * 0.05 }}
                  className="min-w-[240px] flex-shrink-0"
                >
                  <div className="relative overflow-hidden rounded-2xl bg-card border-2 border-border/50 p-5 flex flex-col items-center text-center h-full">
