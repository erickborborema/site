        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="lg:hidden p-2.5 rounded-lg hover:bg-muted transition-colors relative z-50"
              aria-label="Menu"
            >
              <motion.div
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            ...
            {/* Menu Items */}
            <nav className="flex flex-col h-[calc(100vh-80px)] px-4 sm:px-6 py-8">
              <div className="flex flex-col gap-2 flex-1">
                {navLinks.map((link, index) => (
                  <motion.a
                    ...
                    className={`relative flex items-center px-5 py-4 text-lg font-bold rounded-xl transition-all duration-200 ${
                      activeSection === link.href
                        ? "text-green-500 bg-green-500/10 border-2 border-green-500/20"
                        : "text-foreground hover:text-green-500 hover:bg-muted/50 border-2 border-transparent"
                    }`}
                  >
              ...
              <div className="mt-auto space-y-4 pt-6 border-t border-border/50">
                <Button
                  ...
                  className="w-full bg-muted hover:bg-muted/80 text-foreground font-display font-bold text-base py-6 rounded-xl transition-all"
                >
